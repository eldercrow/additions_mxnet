...
def get_symbol_train(num_classes=21, nms_thresh=0.5, force_suppress=False, nms_topk=400):
    ...
    preds, anchors = pvanet_multibox(data, num_classes, 
            patch_size=384, per_cls_reg=per_cls_reg, use_global_stats=use_global_stats, no_bias=no_bias, lr_mult=1.0)
    ...
    tmp = mx.symbol.Custom(*tmp_in, op_type='multibox_target2', name='multibox_target2',
            n_class=num_classes, img_wh=(384, 384), variances=(0.1, 0.1, 0.2, 0.2),
...
def get_symbol(num_classes=21, nms_thresh=0.5, force_nms=False, nms_topk=400):
    ...
    preds, anchors = pvanet_multibox(data, num_classes,
            patch_size=384, per_cls_reg=per_cls_reg, use_global_stats=use_global_stats, no_bias=no_bias)
