...
def train_net(args, ctx, pretrained, epoch, prefix, begin_epoch, end_epoch,
    ...
    if args.resume:
        ...
        arg_params['rpn_bbox_beta'] = mx.nd.zeros((1,))
        arg_params['cls_beta'] = mx.nd.zeros((1,))
        arg_params['bbox_beta'] = mx.nd.zeros((1,))
    ...
    plateau_weights = {}
    for i, m in enumerate(eval_metrics.metrics):
        plateau_weights[m.name] = eval_weights[i]
    plateau_lr = PlateauScheduler(patient_epochs=(2, 2, 3, 3), eval_weights=plateau_weights)
