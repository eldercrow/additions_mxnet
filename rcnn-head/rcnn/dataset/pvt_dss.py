...
class PVTDSS(PascalVOC):
    def __init__(self, image_set, root_path, devkit_path):
        ...
        super(PascalVOC, self).__init__('pvt_' + year, image_set, root_path, devkit_path)  # set self.name
        self.year = year
        self.root_path = root_path
        self.devkit_path = devkit_path
        self.data_path = os.path.join(devkit_path, 'PVTDSS' + year)
