...
def get_hjnet_conv(data, is_test, fix_gamma=True):
    ...
    nf_3x3 = [32, 40, 48, 56, 64] # 24 48 96 192 384
    nf_1x1 = [32*3, 40*3, 48*3, 56*3, 64*3]
    dilates = [((1,1), (1,1), (2,2))] * 5
    n_incep = [2, 2, 2, 2, 1]
...
def get_symbol(num_classes=1000, prefix_symbol='', **kwargs):
    ...
    conv7 = bn_relu_conv(pool6, num_filter=384, postfix_name='7', 
...
if __name__ == '__main__':
    ...
    mod.bind(data_shapes=[('data', (8, 3, 200, 200))])
    mod.init_params()
