...
class DSS(Imdb):
    ...
    def __init__(self, image_set, year, devkit_path,
        ...
        super(DSS, self).__init__('dss_' + year + '_' + image_set)
        self.image_set = image_set
        self.year = year
        self.devkit_path = devkit_path
        self.data_path = os.path.join(devkit_path, 'DSS' + year)
        self.extension = '.jpg'
        ...
        if self.is_train and pad_label:
            self.pad_labels()
    ...
    def evaluate_detections(self, detections):
        ...
        if not os.path.exists(result_dir):
            os.mkdir(result_dir)
        year_folder = os.path.join(self.devkit_path, 'results', 'DSS' + self.year)
        if not os.path.exists(year_folder):
            os.mkdir(year_folder)
        res_file_folder = os.path.join(self.devkit_path, 'results', 'DSS' + self.year, 'Main')
    ...
    def write_pascal_results(self, all_boxes):
        ...
        for cls_ind, cls in enumerate(self.classes):
            print('Writing {} DSS results file'.format(cls))
