...
def parse_args():
    ...
    parser.add_argument('--network', dest='network', type=str, default='facenet',
    ...
    parser.add_argument('--prefix', dest='prefix', help='trained model prefix',
                        default=os.path.join(os.getcwd(), 'model', 'ssd_facenet'),
                        type=str)
    ...
    parser.add_argument('--class-names', dest='class_names', type=str, default='face',
