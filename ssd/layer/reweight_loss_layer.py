...
class ReweightLoss(mx.operator.CustomOp):
    ...
    def forward(self, is_train, req, in_data, out_data, aux):
        ...
        bbox_weight = mx.nd.broadcast_mul(in_data[2], bbox_mask)
        ...
        th_batch = np.transpose(mx.nd.topk(neg_map, axis=1, k=rand_k*self.rand_mult).asnumpy())
...
class ReweightLossProp(mx.operator.CustomOpProp):
    '''
    '''
    def __init__(self, neg_ratio=3.0, reg_ratio=2.0, rand_mult=8):
        #
