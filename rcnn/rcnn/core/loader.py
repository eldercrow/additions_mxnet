...
class AnchorLoaderMS(mx.io.DataIter):
    def __init__(self, feat_sym_list, roidb, batch_size=1, shuffle=False, ctx=None, work_load_list=None,
                 feat_stride_list=(16, 32, 64), anchor_scales=(3,), anchor_ratios=(0.5, 1, 2), allowed_border=0,
                 aspect_grouping=False):
        """
        This Iter will provide roi data to Fast R-CNN network
        :param feat_sym: to infer shape of assign_output
        ...
        :return: AnchorLoader
        """
        super(AnchorLoaderMS, self).__init__()

        # save parameters as properties
        self.feat_sym_list = feat_sym_list
        self.roidb = roidb
        self.batch_size = batch_size
        self.shuffle = shuffle
        self.ctx = ctx
        ...
        # decide data and label names
        assert config.TRAIN.END2END, "Only support end2end training."
        self.data_name = ['data', 'im_info', 'gt_boxes']
        self.label_name = ['label', 'bbox_target', 'bbox_weight']
