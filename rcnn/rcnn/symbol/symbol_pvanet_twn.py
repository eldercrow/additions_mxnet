...
def conv_twn(data, shape, name=None, pad=(0,0), stride=(1,1), no_bias=True):
...
def pvanet_preact(data, is_test):
    ...
    convf_2 = mx.symbol.Convolution(name='convf_2', data=concat, 
            num_filter=384, pad=(0,0), kernel=(1,1), stride=(1,1), no_bias=False)
